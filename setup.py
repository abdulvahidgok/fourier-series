...
setup(
    ...
    description='A Python package with a C++ extension for computing Fourier Series coefficients and generating Fourier Series.',
    long_description=open('README.md').read(),
    long_description_content_type='text/markdown',
    ext_modules=[CMakeExtension("fourier_series", mod_path="fourier_series.", source_dir="core")],
    cmdclass={"build_ext": CMakeBuild},
    packages=['fourier_series'],
    package_dir={'fourier_series': 'src'},
    install_requires=[
        'numpy==1.26.4',
    ],
    zip_safe=False,
